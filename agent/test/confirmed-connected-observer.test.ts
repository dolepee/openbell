...
async function rpc(label: string, overrides: { pinnedHash?: Hex; status?: number; usedNonce?: boolean } = {}): Promise<ReadOnlyJsonRpc> {
  ...
  return {
    ...
    async request(method, params) {
      ...
      if (method === "eth_getBlockByNumber") {
        ...
        return { number: "0x64", hash: overrides.pinnedHash ?? pinnedHash, timestamp: "0x6a7d4a54" };
      }
      if (method === "eth_call") {

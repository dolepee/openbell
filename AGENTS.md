...
- Preserve the explicit boundary: the testnet lifecycle is a no-value fixture; mainnet has deployment evidence only, with no lifecycle or real-value activity.

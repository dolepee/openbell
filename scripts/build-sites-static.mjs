...
for (const path of ["index.html", "app.js", "deal-package.mjs", "funding-candidate.mjs", "testnet-flow.mjs", "styles.css", "data", "public", "studio", "operate", "mainnet", "fund", "workspace", "proof", "architecture"]) {
